...
@Document(collection = "daba_daba")
public class daba_daba {
    ...
    private Integer montant_recharge; 

    private String motif_echec;


    public daba_daba(String _id, String canal, String date, Integer num_compte, String num_tiers, String marche, String reference, String statut, String userIP, Integer montant_recharge, String motif_echec) {
        this._id = _id;
        this.canal = canal;
        this.date = date;
    ...
    public Integer getMontant_recharge() {
        return this.montant_recharge;
    }

    public void setMontant_recharge(Integer montant_recharge) {
        this.montant_recharge = montant_recharge;
    }
